---
title: Input Systems, State Machines, Events
---
...
To recap, we've already learned how to map inputs to certain lines of code [using KeyCodes and GetKey](./4-basicinput-ui-lights-camera.md/#basic-input). 

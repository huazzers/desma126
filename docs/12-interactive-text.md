...
3. Set up your player and trigger zone for [**trigger detection**](./6-physics-engine.md/#triggers) -- here's a link to the [collision matrix](./img/unitycollisionmatrix.png) for your reference. 

...
| W6  | **02/10**</br><p>Studio Time: One-on-one meetings</p> | **02/12**</br><div class="due"><p>📌 DUE: </p><ul><li>Project 2</li></ul></div><div class="assign"><p>▶️ ASSIGN:</p><ul><li>Project 3 (W10 Tue, 03/10)</li><li>Homeplay Response 2 (W8 Tue, 02/24)</li></ul></div>|

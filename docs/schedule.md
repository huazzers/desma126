...
| W4  | **04/22**</br><p>Lecture: [Game + Play + Level Design!](./5-game-play-level-design.md)</p><p><mark class="assign">▶️ ASSIGN: Homeplay 2 (In-Class)</mark></p> | **04/24**</br><p><mark class="due">📌 DUE: Reading Response 2</mark></p><p>Tutorial: [Physics Engine: Rigidbody, Collider, Collisions, Triggers](./6-physics-engine.md)</p>|
| W5  | **04/29**</br><p><mark class="due">📌 DUE: Ball Game Research</mark></p><p>Tutorial: [Input Systems, State Machines, Events](./7-inputsystem-statemachine-event.md)</p> | **05/01**</br><p>Tutorial: [Statics, Scenes, Sounds, VFX](./8-statics-scenes-sounds-vfx.md)</p>|

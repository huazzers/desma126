...
| W10  | **03/10**</br><p>Studio Time: One-on-one meetings + Open Work Time</p> | **03/12**</br><div class="due"><p>📌 DUE: </p><ul><li>Project 3</li></ul></div><p>Project 3 Crit Day</p><div class="assign"><p>▶️ ASSIGN:</p><ul><li>[Optional Extra Credit](./extra-credit.md)(W10 Fri, 03/13)</li></ul></div> |
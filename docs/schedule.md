...
| W3  | **01/20**</br><div class="due"><p>📌 DUE: </p><ul><li>Project 1</li></ul></div><p>Lecture: [Game + Play + Level Design](https://docs.google.com/document/d/153ZxARwoVYxellAte1QKVTpTRzPndrwJnrQ6ozmQI4A/edit?usp=sharing)</p><div class="assign"><p>▶️ ASSIGN:</p><ul><li>Project 2</li><li>Reading Response 2 (W4 Tue, 01/27)</li></ul></div> | **01/22**</br><p>Tutorial: Prototyping Game Environments</p><blockquote><p>Grayboxing Tips, Unity Terrain, Simple Roll-a-ball Player</p></blockquote><p>Tutorial: Physics Engine<p><blockquote><p>Rigidbodies, Colliders, Collisions, Triggers</p></blockquote>|
